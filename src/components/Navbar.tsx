...
const navItems = ["Services", "Portfolio", "Why Us", "Contact"];

const navScrollIds: Record<string, string> = {
  "Services": "services",
  "Portfolio": "portfolio",
  "Why Us": "why-us",
  "Contact": "contact",
...
const Navbar = () => {
  ...
  const scrollTo = (item: string) => {
    setMenuOpen(false);
    const id = navScrollIds[item] ?? item.toLowerCase();
