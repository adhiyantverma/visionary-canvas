...
import { Globe, Heart, UtensilsCrossed, Palette } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description: "Digital invitations as elegant as your celebration — beautifully designed, easy to share.",
    link: "Learn more →",
  },
  {
      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="body-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
            From digital experiences to print-ready designs, we help brands shine at every touchpoint.
          </p>
        </motion.div>
