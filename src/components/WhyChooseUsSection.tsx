...
const stats = [
  { icon: Users, value: "50+", label: "Happy Clients", description: "Trusted by businesses, couples, and restaurants across the region." },
  { icon: Zap, value: "Fast", label: "Turnaround", description: "Most projects delivered within 1–2 weeks without sacrificing quality." },
  { icon: DollarSign, value: "Fair", label: "Pricing", description: "Transparent, competitive pricing with no hidden fees or surprises." },
];
